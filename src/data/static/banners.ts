...
export const masonryBanner = [
  {
    ...
    image: {
      ...
      desktop: {
        url: '/assets/images/banner/masonry/banner-1.png',
        width: 1078,
        height: 425,
      },
    },
  ...
  },
  {
    ...
    image: {
      ...
      desktop: {
        url: '/assets/images/banner/masonry/banner-6.png',
        width: 1078,
        height: 425,
      },
    },
...
export const gridBanner = [
  {
    ...
    image: {
      ...
      desktop: {
        url: '/assets/images/banner/grid/banner-1.png',
        width: 885,
        height: 430,
      },
    },
...
export const promotionBanner = [
  {
    ...
    image: {
      mobile: {
        url: '/assets/images/banner/slider/mobile/banner-1.png',
        width: 450,
        height: 180,
      },
      desktop: {
        url: '/assets/images/banner/slider/banner-1.png',
        width: 1440,
        height: 570,
      },
    },
...
export const standardDemoPromotionBanner = [
  {
    ...
    image: {
      ...
      desktop: {
        url: '/assets/images/banner/small/banner-1.png',
        width: 580,
        height: 360,
      },
    },
...
export const minimalDemoHeroBanner = [
  {
    ...
    image: {
      ...
      desktop: {
        url: '/assets/images/hero/two/banner-1.png',
        width: 1450,
        height: 800,
      },
    },
...
export const vintageDemoGridBanner = [
  {
    ...
    image: {
      ...
      desktop: {
        url: '/assets/images/banner/grid/small/banner-1.png',
        width: 980,
        height: 340,
      },
    },
...
export const trendyDemoHeroBanner = [
  {
    ...
    image: {
      mobile: {
        url: '/assets/images/banner/trendy/mobile/banner-1.png',
        width: 480,
        height: 275,
      },
      desktop: {
        url: '/assets/images/banner/trendy/desktop/banner-1.png',
        width: 1800,
        height: 800,
      },
    },
...
export const techHomeHeroGridSlider = [
  {
    ...
    image: {
      mobile: {
        url: '/assets/images/hero/small/banner-1.png',
        width: 690,
        height: 480,
      },
      desktop: {
